...
const ChessGameWrapper = (props) => {
  ...
  // const domainName = "https://shishu-teams.herokuapp.com";
  const domainName = "localhost:5001"
  ...
  return (
    <React.Fragment>
      {opponentDidJoinTheGame ? (
        <div>
          <h4 style={{ color: "black" }}> Opponent: {opponentUserName} </h4>
          ...
          <h4 style={{ color: "black" }}> You: {props.myUserName} </h4>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            value={domainName + "/playChess/game/" + gameid}
            type="text"
          ></textarea>
          <br></br>
