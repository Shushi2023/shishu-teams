...
const AuthProvider = ({children}) => {
    ...
    const resetPassword = (email) => { //For resetting the password
        return auth.sendPasswordResetEmail(email);
    }

    const value = { //This will be the value returned 
        currUser, 
        signUp, 
        logIn, 
        logOut, 
